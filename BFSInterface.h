...
status_t bfs_read_dir(void *_ns, void *_node, void *_cookie, struct dirent *Dirent, 
...
status_t bfs_read(void *_ns, void *_node, void *_cookie, off_t pos, void *buffer, off_t *_length);
...
status_t bfs_read_attr_dir(void *_ns, void *node, void *_cookie, struct dirent *dirent, size_t bufferSize, uint32 *_num);
...
status_t bfs_read_attr(void* _fs, fs_vnode _file, attr_cookie* _cookie, off_t pos, void *buffer, off_t *_length);
