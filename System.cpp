...
int
read_pos(HANDLE fDevice, int64_ sStart, void* data, unsigned int size)
{
...
int
read_pos2(HANDLE fDevice, int64_ sStart, void* data, unsigned int size)
{
	char*  q = (char* )calloc(size,sizeof(char));
	DWORD dwBytes;
	LARGE_INTEGER sbStart;
...
ssize_t
readv_pos(HANDLE fDevice, off_t pos, const struct iovec* vec, size_t count)
{
...
int
write_pos(HANDLE fDevice, int64_ sStart, void* data, unsigned int size)
{
...
status_t
publish_vnode (unsigned int mountID, off_t vnodeID, void* privateNode)
{
...
status_t
new_vnode (unsigned int mountID, off_t vnodeID, void* privateNode)
{
...
status_t
remove_vnode (unsigned int mountID, off_t vnodeID)
{
...
status_t
unremove_vnode (unsigned int mountID, off_t vnodeID)
{
...
status_t
cache_next_block_in_transaction(void* a, int,unsigned int* b, off_t*  c, int d, int e)
{
...
void
notify_query_entry_created(int a, int b, unsigned int c,off_t d, const char* e, off_t f)
{ 
...
void
notify_query_entry_removed(int a, int b, unsigned int c,off_t d, const char* e, off_t f)
{
...
ssize_t
writev_pos(HANDLE fd, off_t pos, const struct iovec* vec,size_t count)
{
