...
//====================MAIN DIALOG==========================================//
BOOL CALLBACK
PropertiesDlgProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void
AddAttrInfo(char* pszAttrName, char* pszAttrData, char* type, int iAccess)
{
	LVITEM LvItem;
